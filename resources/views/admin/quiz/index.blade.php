                    ...
                    <tr>
                        ...
                        <td>
                            <div>
                                ...
                                @if($quiz->deskripsi)
                                <p class="text-muted small mb-0">{{ Str::limit($quiz->deskripsi, 50) }}</p>
                                @endif
                            </div>
                        </td>
                        <td>
                            @if($quiz->training)
                            <span class="badge text-bg-info">{{ $quiz->training->judul }}</span>
                            @else
            ...
            <div class="modal-body">
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <p><span class="badge text-bg-primary">{{ $quiz->questions_count ?? 0 }}</span></p>
                    </div>
                    <div class="col-12 col-md-6">
