        ...
        <div class="col-12 col-lg-8 mx-auto">
            ...
            <div class="panel">
                <div class="panel-header">
                    <div>
                        <h5 class="section-title"><i class="bi bi-tag text-primary"></i> Form Tambah Kategori</h5>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                          ...
                                          placeholder="Deskripsikan kategori ini secara lengkap...">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text" id="colorPreview" style="background-color: #4e9af1; width: 40px;"></span>
                                    ...
                                    <input type="text" class="form-control @error('warna') is-invalid @enderror" 
                                           id="warnaText" value="{{ old('warna', '#4e9af1') }}" 
                                           placeholder="#4e9af1" style="flex: 1;">
                                </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="p-4 border rounded-3 bg-light text-center">
                                    <span id="previewBadge" class="badge" style="background-color: #4e9af1; color: #fff; font-size: 1.1rem; padding: 10px 24px;">
