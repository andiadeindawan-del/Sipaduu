...
<div class="container-fluid px-3 px-lg-4 py-4">
    ...
    <div class="panel">
        <div class="panel-header">
            <div>
                <h5 class="section-title"><i class="bi bi-pencil-square"></i> Form Edit Dokumentasi</h5>
                <p class="text-muted small mb-0">Ubah data dokumentasi <strong>{{ $dokumentasi->judul }}</strong></p>
            </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="judul" class="form-control @error('judul') is-invalid @enderror" 
                                   value="{{ old('judul') ?? $dokumentasi->judul }}" placeholder="Masukkan judul dokumentasi" required>
                        </div>
                        @error('judul')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="url" name="link" class="form-control @error('link') is-invalid @enderror" 
                                   value="{{ old('link') ?? $dokumentasi->link }}" placeholder="https://example.com/dokumentasi" required>
                        </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            ...
                            <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" 
                                      rows="3" placeholder="Deskripsi dokumentasi (opsional)">{{ old('deskripsi') ?? $dokumentasi->deskripsi }}</textarea>
                        </div>
                        @error('deskripsi')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="col-12">
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-6">
                                ...
                                <p class="mb-0">{{ $dokumentasi->created_at ? $dokumentasi->created_at->format('d/m/Y H:i') : '-' }}</p>
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="text-muted small fw-semibold">Terakhir Diperbarui</label>
                                <p class="mb-0">{{ $dokumentasi->updated_at ? $dokumentasi->updated_at->format('d/m/Y H:i') : '-' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
