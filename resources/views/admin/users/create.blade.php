        ...
        <div class="col-12 col-lg-8 mx-auto">
            <div class="panel">
                <div class="panel-header">
                    <h5 class="section-title"><i class="bi bi-person-plus"></i> Form Tambah User</h5>
                    <p class="text-muted small mb-0">Isi data user dengan lengkap.</p>
                </div>
                <div class="p-4">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control @error('alamat_lengkap') is-invalid @enderror" 
                                              ...
                                              placeholder="Enter complete address">{{ old('alamat_lengkap') }}</textarea>
                                </div>
